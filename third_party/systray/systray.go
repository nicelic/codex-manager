...
// SetOnIconDoubleClick registers a callback for a double click on the tray icon.
// A single left click remains intentionally unhandled; right click continues to
// open the native tray menu on Windows.
func SetOnIconDoubleClick(handler func()) {
